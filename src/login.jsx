               ...
               <body className="bg-gradient-to-r from-cyan-800 to bg-cyan-950">
                ...
                ``           <ul className="flex-1 text-center">
                    ...
                    <div className="mt-48 mr-40">
                      ...
                      <div className="mt-20">
                        <a href="#" className="bg-yellow-300 border-2 rounded-3xl py-4 px-12 font-medium inline-block mr-20 hover:text-3xl" onClick={()=>{Navigate("/signup")}}>Provider</a>
                        <a href="#" className="bg-yellow-300 border-2 rounded-3xl py-4 px-9 font-medium inline-block hover:text-3xl ">Organization</a>
