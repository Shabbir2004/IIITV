...
const Org=()=>{
    ...
    return(
        ...
        <div className="absolute w-[25%] gap-20 h-[80%] flex flex-col justify-center items-center border-2 border-slate-300 p-4 backdrop-blur-md  rounded-xl">
            ...
            <button className="text-slate-200 p-4 rounded-full font-semibold backdrop-blur-md border-slate-300 border-2 text-2xl px-16 hover:text-3xl font-serif" onClick={()=>{Navigate("/orgdet")}}>LOGIN</button>
